...
ffmpeg -nostdin   -fflags nobuffer   -flags low_delay   -f mpegts   -i 'udp://@0.0.0.0:8554?overrun_nonfatal=1&fifo_size=500000'   -fflags nobuffer   -vf format=yuv420p   -f v4l2 /dev/video42
